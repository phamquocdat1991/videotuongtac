...
<iframe 
  src="./video_tuong_tac_ai_${(videoTitle || 'bai_giang').toLowerCase().replace(/\s+/g, '_')}.html" 
  width="${embedWidth}" 
  height="${embedHeight}" 
...
></iframe>`;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-700/80 rounded-2xl max-w-xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-900/95">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white">Mã Nhúng Iframe Cho Hệ Thống LMS</h3>
